...
export PYTHONPATH=$PYTHONPATH:/root/bucket_vast
...
# Inject --force-bucketing when bucket grad overlap is enabled.
...
echo "Final launch command:"
printf '  %q' "${LAUNCH_CMD[@]}"
echo

"${LAUNCH_CMD[@]}" #> test/test_data/tp${TP}cp${CP}_layer36.log
