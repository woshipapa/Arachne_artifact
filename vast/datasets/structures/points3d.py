...
class Points3D(BaseStructure):
    ...
    def convert_to(self, dst_mode, rot_mat=None):
        return points3d_utils.convert_points3d(
    ...
    def in_range_bev(self, point_range):
        return points3d_utils.points3d_in_range_bev(
            self.tensor, point_range, self.bev_axis
        )
    ...
    def rotate(self, angle=None, rot_mat_t=None):
        ...
        self.tensor[:, :3] = points3d_utils.rotate_points3d(
            self.tensor[:, :3], rot_mat_t
        )

    def flip(self, bev_direction="horizontal"):
        self.tensor = points3d_utils.flip_points3d(
            self.tensor, self.flip_axis, bev_direction
        )
