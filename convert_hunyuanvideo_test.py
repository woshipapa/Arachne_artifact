...
# model = HunyuanVideoTransformer3DModel.from_pretrained("/root/ckpt_2040_hf")

# model_origin = HunyuanVideoTransformer3DModel.from_pretrained("/root/transformer_safetensor")

model = HunyuanVideoTransformer3DModel.from_pretrained("/root/ckpt_2040_hf_iter_0000800_test", use_safetensors=False)

# print(model)

# model = torch.load("/root/diffusion_pytorch_model.bin")
# model = torch.load("/root/diffusion_pytorch_model.bin")
