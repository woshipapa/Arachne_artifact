...
DUMP_RANK_TASKS = False            # === NEW === 是否输出每个 rank 的 task list
COLLECT_FINAL_SP4 = True          # === NEW === 是否统计 SP=4 的 iteration

SP_SIZE_TO_TRACK = 4              # 这里写 4，后续也可扩展
...
def load_and_analyze_trace(csv_path: str) -> Dict:
    """
    读取一个 trace csv，直接返回 analyze_straggler_from_csv 的结果
    """
...
def build_cross_schedule_compare(
    ...
    """
    对同一个 iteration，在两个 schedule 下做横向对比
    """
    primary_csv = (
...
def plot_schedule_from_csv(
    ...
    # ============================================================
# NEW: FlexSP vs Megatron final-task 一致性判定
# ============================================================
