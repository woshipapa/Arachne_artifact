...
def _add_distributed_args(parser):
    ...
    group.add_argument('--force-bucketing', action='store_true',
                       default=False,
                       help='If set, keep per-bucket grad tensors in DDP regardless of '
                            '--overlap-grad-reduce. Required by the heterogeneous grad sync '
                            '(sync_grads_with_plan) to pipeline AllReduce and Broadcast at '
                            'bucket granularity.')
