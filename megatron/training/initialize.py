...
def initialize_megatron(
    ...
    if args.lazy_mpu_init:
        ...
        # setup_logger(log_dir = "global_log")
...
def _initialize_distributed():
    ...
    # initialize Arachne integration system
    from t2v_flow.integration import SystemManager
    # trigger register
    import t2v_flow.integration.MainIntegrationSystem
    SystemManager().initialize_all(args)
    ...
    if device_count > 0:
        if mpu.model_parallel_is_initialized():
            ...
            logger.info(f"> initialized model parallel ...")
            if args.rank == 0:
                logger.info(
