...
# python tools/train.py projects/cogvideox/configs/cogvideox_i2v.py 2>&1 | tee test_cog.log
# python tools/train.py projects/hunyuanvideo/configs/hunyuanvideo_i2vhy.py 
python tools/train.py projects/wan/configs/wan_i2vhy.py 2>&1 | tee test_wan.log