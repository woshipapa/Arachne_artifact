...
class ProfilerWrapper:
    def __init__(self,is_st: bool, activities=None, profile_memory=False, record_shapes=True, 
                 ...
                 mem_dir='/root/vast3/memory_logs',
                 thresold: int = 4,
    ...
    def plot_memory_line(self):
        ...
        file_path = os.path.join(self.output_dir,f"{self.prefix}_memory_usage.txt")
        ...
        # 显示图形
        plt.tight_layout()
        plot_path = os.path.join(self.output_dir,f"{self.prefix}_memory_usage_line_chart.png")
